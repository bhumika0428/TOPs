...
departmentinfomatation obj= DepartmentInfoDao.getByIdDepartmentinfomatation(id);
session.setAttribute("update", obj);

%>
<br>
<div>
<form action="EditDepartmentinfoServlet" method="post">
...
<div class="col"></div>
	...
	<label class="form-label">Department Name</label>
		<select class="form-control" class="btn btn-light btn-lg dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name="edepartment">
			<option><%=obj.getDepartmentName() %></option>
