<%@page import="Dao.ProjectDetailsDao"%>
<%@page import="Pojo.ProjectDetails"%>
				...
				<div class="row ">
					...
					<div class="col-lg-4  col-sm-12" style="text-align: center;">
						<label class="form-label">Project Name</label> <input type="text"
							name="pName" class="form-control" value="<%=obj.getProjectName()%>">

					</div>
					<div class="col-lg-4 col-sm-12" style="text-align: center;">
						<label class="form-label">ProjectDetails</label>
						<textarea class="form-control" name="pdetails" ><%=obj.getProjectDetails() %></textarea>
					</div>
				</div>
				<br>
				<div class="row ">
					...
					<div class="col-lg-3 col-sm-12" style="text-align: center;">
						<label class="form-label">Project Language</label> <select
							...
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
							name="pLanguage">
							<option value="<%=obj.getProjectLanguage()%>"><%=obj.getProjectLanguage() %></option>
							<option>Select Option</option>
					...
					<div class="col-lg-3  col-sm-12" style="text-align: center;">
						<label class="form-label">Project Status</label> <select
							...
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
							name="eStatus">
							<option value="<%=obj.getProjectStatus()%>"><%=obj.getProjectStatus() %></option>
							<option>Select Option</option>
					...
					<div class="col-lg-3 col-sm-12" style="text-align: center;">
						...
						<input class="form-control" type="date" name="start" value="<%=obj.getStartDate()%>">

					</div>
					<div class="col-lg-3 col-sm-12" style="text-align: center;">
						<label class="form-label">End Date</label> <input
							class="form-control" type="date" name="end" value="<%=obj.getEndDate()%>">
