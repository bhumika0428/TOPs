...
<br>
<div>
<form action="editProfileDetails" method="post" enctype="multipart/form-data">
<div style="text-align: center;" class="container-fluid" >
<h2>Profile Details</h2>	
<br><br>
<input name="pid" type="text" value="<%=obj.getProfileId()%>">
...
<div class="row " >
	...
	<label class="form-label">Employee Name</label>
		<select class="form-control" class="btn btn-light btn-lg dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name="ename">
			<option value="<%=obj.getEmployeeDetails().getEmployeeId()%>"><%=obj.getEmployeeDetails().getEmployeeName() %></option>
